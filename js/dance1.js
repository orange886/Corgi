...
function cmp_loaded(key) {
	cmpo = CMP.get("cmp");
	if (cmpo) {
		cmpo.addEventListener("model_complete", "getNext");
	}
}
function bfqzt(){
   document.writeln("<iframe marginwidth=\"0\" marginheight=\"0\" src=\""+cscms_path+"real/cookie.php\" frameborder=\"0\" width=\"0\" scrolling=\"no\" height=\"0\" leftmargin=\"0\" topmargin=\"0\"></iframe>");
}